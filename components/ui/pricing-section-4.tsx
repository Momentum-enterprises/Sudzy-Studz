...
const plans = [
  {
    name: "Starter",
    description:
      "Great for small teams getting started with modern workflows",
    price: 12,
    yearlyPrice: 99,
  ...
  },
  {
    name: "Business",
    description:
      "Best value for growing businesses needing advanced features",
    price: 48,
    yearlyPrice: 399,
    buttonText: "Get started",
  ...
  },
  {
    name: "Enterprise",
    description:
      "Advanced plan with enhanced security and unlimited team access",
    price: 96,
    yearlyPrice: 899,
    buttonText: "Get started",
    buttonVariant: "outline" as const,
...
export default function PricingSection4() {
  ...
  return (
    <div
      className="min-h-screen mx-auto relative bg-black overflow-x-hidden px-4 pb-12"
      ref={pricingRef}
    >
      <TimelineContent
        animationNum={4}
      ...
      <article className="text-center mb-6 pt-24 md:pt-32 max-w-3xl mx-auto space-y-2 relative z-50">
        ...
        >
          Trusted by millions. Compare monthly or yearly and choose what fits now.
        </TimelineContent>
