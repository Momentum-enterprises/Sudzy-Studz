...
await p.setViewport({ width: 1440, height: 2400, deviceScaleFactor: 2 });
...
const el = await p.$('#donate');
await el.screenshot({ path: './temporary screenshots/screenshot-14-donate.png' });
await b.close();
console.log('ok');
